...
export default class Drawable {
    ...
    static POINTS: Constants.DrawType = Constants.DrawType.POINTS;
    static LINES: Constants.DrawType = Constants.DrawType.LINES;
    static LINE_STRIP: Constants.DrawType = Constants.DrawType.LINE_STRIP;
    static LINE_LOOP: Constants.DrawType = Constants.DrawType.LINE_LOOP;
    static TRIANGLES: Constants.DrawType = Constants.DrawType.TRIANGLES;
    static TRIANGLE_STRIP: Constants.DrawType = Constants.DrawType.TRIANGLE_STRIP;
    static TRIANGLE_FAN: Constants.DrawType = Constants.DrawType.TRIANGLE_FAN;
    ...
    protected _drawType: Constants.DrawType = Constants.DrawType.TRIANGLES;
    ...
    public update(): void {
        if (
            ...
            this.scale.updated ||
            GLContext.scale.updated ||
            GLContext.camera.updated
        ) {
            ...
            this._viewMatrix.replace(
                ...
                .mul(
                    new Matrix3(
                        1, 0, 0,
                        0, 1, 0,
                        GLContext.camera.x, GLContext.camera.y, 1,
                    )
                )
                .mul(
                    new Matrix3(
                        GLContext.scale.x, 0, 0,
                        0, GLContext.scale.y, 0,
                        0, 0, 1,
                    )
                )
                .mul(
